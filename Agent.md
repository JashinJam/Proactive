...
- R0, R0-F, the four-session R1 protocol pilot, D1, D2, D3, U1-V, D3-D, and D4 are complete. The active formally promoted scientific baseline remains D3 `dynamics_fused`, official OOF Macro F1 `0.6690`. D4 packages the non-promotable `0.6846` D3-D diagnostic as one frozen leaderboard-engineering candidate; its 1,052-parameter head, 9,935-chunk online replay, and 10-chunk shared-vision GPU smoke are complete. The active next step is submission packaging/entry-point audit, not more feature search.
